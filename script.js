...
if (passwordInput.value.trim() === '') { // Verificar si el campo está vacío
  ...
  // Si todos los campos son válidos, enviar los datos al servidor (esto se manejaría en el servidor, no aquí)
  if (isValid) {
    // Aquí enviarías los datos al servidor para autenticar al usuario
    // No incluido en este código, ya que es específico del servidor
  }
});
